...
1. On the left navigation pane, expand **Entra ID** then navigate to **Cross-tenant synchronization** > **Configurations**.
...
1. You should still be logged into the **Microsoft Entra admin center** **`https://entra.microsoft.com`** in the Provisioning settings of your just created configuration. If not follow these 3 steps to get back there:
...
1. You should still be logged into the **Microsoft Entra admin center** **`https://entra.microsoft.com`** in the **Users and groups** settings of your cross-tenant synchronization configuration. If not follow these 2 steps to get back to the configuration page:
...
1. You should still be logged into the **Microsoft Entra admin center** **`https://entra.microsoft.com`** in the Provisioning settings of your cross-tenant synchronization configuration. If not follow these 2 steps to get back to the configuration page:
   1. On the left navigation pane, expand **Entra ID** then navigate to **External Identities** > **Cross-tenant synchronization** > **Configurations**.
   1. Select **Contoso cross-tenant synchronization**
...
Since the first user provisioning was successfully tested you will now provision the rest of your user list to the other tenant.

1. You should still be logged into the **Microsoft Entra admin center** **`https://entra.microsoft.com`** in the **Provision on demand** page of your cross-tenant synchronization configuration. If not follow these 2 steps to get back to the configuration page:
   1. On the left navigation pane, expand **Entra ID** then navigate to **External Identities** > **Cross-tenant synchronization** > **Configurations**.
   1. Select **Contoso cross-tenant synchronization**
