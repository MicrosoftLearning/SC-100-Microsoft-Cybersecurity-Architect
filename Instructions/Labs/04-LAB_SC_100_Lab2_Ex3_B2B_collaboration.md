...
lab:
  ...
  description: Contoso recently acquired Tailwind Traders and it has been difficult
    to determine which guests are customers or partners, and which are employees of
    the acquired company. You need to establish cross-tenant synchronization to enable
    collaboration while maintaining Zero Trust principles. You will restrict guest
    invitation rights, limit external access to trusted domains, and configure bidirectional
