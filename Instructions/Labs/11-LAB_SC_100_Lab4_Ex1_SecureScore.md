...
In this task, you'll set up a custom role focused on security posture and more specifically on Exposure Management. As part of the custom role, you'll grant Joni Sherman access to the data source for Exposure Management.
...
You successfully set up a custom role for security posture that grants Joni Sherman access to the Exposure Management data source.
...
As Joni Sherman, you successfully edited the status for the recommended action.
