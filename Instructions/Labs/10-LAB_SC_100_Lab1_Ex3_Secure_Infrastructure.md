...
1. Under **Windows Event Logs**, select all available checkboxes for the **Application**, **Security**, and **System** event logs.
...
1. On the **Create Data Collection Rule** page, select **Review + create**.
