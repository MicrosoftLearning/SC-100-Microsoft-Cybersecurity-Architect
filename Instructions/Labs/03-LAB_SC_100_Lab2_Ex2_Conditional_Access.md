...
1. Select **+** to add the IP address you noted in **Step 4.**
    ...
    >**Note:** Named locations require CIDR notation. Append `/32` to the IP address. For example: `185.254.59.125/32`. The input should look similar to `168.245.***.***/32`.
...
1. Switch back to your Edge browser window where you should still be logged into the **Microsoft Entra admin center** **`https://entra.microsoft.com`**.
...
3. Select the policy **Block access outside Trusted Network**, then select **View or Edit** button.

4. Under **Users or agents** select **Specific users included**.
...
5. Under **Users or agents**, select **0 users or agents selected**.
    1. Under **Include** select **Select users and groups** and tick **Users and groups**.
...
1. On the **Policy details** pane, select **View or Edit** button.

1. Under **Users or agents** select **Specific users included**.
