...
lab:
  ...
  description: In this Task you will use the Microsoft Entra admin center to create an own Authentication strength to restrict the use of SMS OTP within your organization.
  duration: 20 minutes
  level: 300
  islab: true
---
