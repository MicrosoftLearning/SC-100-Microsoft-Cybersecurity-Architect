...
lab:
  ...
  description: Contoso aims to enhance its cybersecurity posture by identifying and
    managing its external attack surface, including assets hosted on different cloud
    providers. You will use Microsoft Defender External Attack Surface Management
    (EASM) to discover exposed resources and integrate the data with Sentinel for
